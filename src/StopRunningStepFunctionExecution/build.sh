#!/bin/bash
dotnet publish ./StopRunningStepFunctionExecution.csproj --configuration "Release" --framework "netcoreapp3.1" /p:PublishReadyToRun=true /p:GenerateRuntimeConfigurationFiles=true --runtime linux-musl-x64 --self-contained false
